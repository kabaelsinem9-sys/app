...
const navLinks = [
  { name: "Cycles",          href: "#features"      },
  { name: "Phases",          href: "#how-it-works"  },
  { name: "Gravity",         href: "#infra"         },
  { name: "Recent Deposits", href: "#integrations"  },
];
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>Eclipse Finance</span>
