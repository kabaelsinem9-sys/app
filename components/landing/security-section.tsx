...
const securityFeatures = [
  {
    ...
    description: "Each cycle vault is stateless and self-contained. No cross-contamination risk.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Multi-sig controls",
    description: "Treasury and protocol upgrades require 4-of-7 multi-signature. Hardware wallets. Geo-distributed signers.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full on-chain verifiability",
    description: "All yields, fees, and discounts are verifiable on Solana. Trust through transparency.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Strict permission tiers",
    description: "Emergency pause by guardians. Timelocked parameter changes. veUMBRA governance for major upgrades.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Paladin", "Blocksec", "OtterSec", "Neodyme"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Darkness protects
            <br />
            <span className="text-muted-foreground">what light reveals.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Smart contracts hardened by battle-tested security. Your deposits don&apos;t just earn — they survive. Zero exploits. Zero compromises.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Security incidents since genesis</span>
              </div>
            </div>
