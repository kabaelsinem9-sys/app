...
const features = [
  {
    number: "01",
    title: "Penumbra",
    description: "Deposit assets and receive ECL tokens at a built-in 20% discount. The moon begins to cross the sun. Your entry price is automatically below market.",
    stats: { value: "20%", label: "entry discount" },
  },
  {
    number: "02",
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-end">
            <div className="lg:col-span-7">
              ...
              >
                Perpetual
                <br />
                <span className="text-muted-foreground">yield vaults.</span>
              </h2>
            </div>
            <div className="lg:col-span-5 lg:pb-4">
              <p className={`text-xl text-muted-foreground leading-relaxed transition-all duration-1000 delay-200 ${
                ...
                Deposit SOL or USDC into time-locked eclipse vaults. Your capital farms automatically across integrated protocols while the discount compounds. Zero supervision. Pure gravity.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="relative flex-1 p-8 lg:p-12 bg-black">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl lg:text-4xl font-display mt-4 mb-2 group-hover:translate-x-2 transition-transform duration-500">
                  {features[0].title}
                </h3>
                <span className="text-xl text-muted-foreground/60 font-display block mb-6">The discount entry.</span>
