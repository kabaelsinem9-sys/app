...
const regions = [
  { name: "Kamino", nodes: 12, status: "active", unit: "vaults" },
  { name: "Jupiter", nodes: 8, status: "active", unit: "pools" },
  { name: "Jito", nodes: 6, status: "active", unit: "strategies" },
  { name: "Meteora", nodes: 3, status: "active", unit: "positions" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Your capital doesn&apos;t sit idle. It flows through battle-tested DeFi protocols, executing delta-neutral strategies across Solana&apos;s deepest liquidity pools. Maximum yield. Minimal risk.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <span className="text-2xl text-muted-foreground">integrated pools</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Yield-generating strategies distributed across Solana&apos;s top venues. Auto-compounded. Auto-rebalanced.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-100 ${
              ...
              <span className="text-5xl lg:text-6xl font-display">99.97%</span>
              <span className="block text-sm text-muted-foreground mt-2">Uptime</span>
            </div>
            ...
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              ...
              <span className="block text-sm text-muted-foreground mt-2">Deposit finality</span>
            </div>
          </div>
        </div>
        ...
        <div className={`mt-12 grid grid-cols-2 lg:grid-cols-4 gap-4 transition-all duration-1000 delay-300 ${
          ...
          {regions.map((region, index) => (
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">{region.nodes} {region.unit}</span>
            </div>
          ))}
        </div>
      </div>
