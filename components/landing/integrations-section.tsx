...
const integrations = [
  { name: "$12,400 deposited", category: "2m ago" },
  { name: "$8,200 deposited", category: "5m ago" },
  { name: "$31,600 deposited", category: "11m ago" },
  { name: "$27,000 deposited", category: "11m ago" },
  { name: "$4,900 deposited", category: "14m ago" },
  { name: "$18,700 deposited", category: "18m ago" },
  { name: "$1,500 deposited", category: "18m ago" },
  { name: "$22,100 deposited", category: "23m ago" },
  { name: "$6,300 deposited", category: "27m ago" },
  { name: "$15,800 deposited", category: "31m ago" },
];
    ...
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
          ...
          Capital crossing
          <br />
          <span className="text-muted-foreground">the event horizon.</span>
        </h2>

        <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          isVisible ? "opacity-100" : "opacity-0"
        }`}>
          Live deposits flowing into eclipse vaults. Every transaction you see below — real capital, real time, real yield entering the cycle.
        </p>
      </div>
      ...
      <div className="relative z-10 mt-0 lg:-mt-24 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`flex flex-wrap items-center justify-between gap-8 pt-12 border-t border-foreground/10 transition-all duration-1000 delay-500 pb-32 lg:pb-40 ${
          ...
          <div className="flex flex-wrap gap-12">
            {[
              { value: "20%", label: "Entry discount" },
              { value: "1.56x", label: "Average cycle multiplier" },
              { value: "4,100+", label: "Cycles completed" },
            ].map((stat) => (
