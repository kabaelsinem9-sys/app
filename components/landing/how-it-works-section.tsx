...
const steps = [
  {
    number: "01",
    title: "Deposit",
    subtitle: "Enter the eclipse.",
    description: "Stake SOL or USDC into the vault. Receive discounted ECL tokens at 20% below market. Your orbit begins.",
  ...
  },
  {
    ...
    description: "Your capital enters delta-neutral farming across Kamino, Jupiter, and Jito. Concentrated liquidity. Basis trading. Auto-compounding. Zero intervention required.",
  ...
  },
  {
    number: "03",
    title: "Redeem",
    subtitle: "Exit with yield.",
    description: "ECL tokens redeem at full face value. You keep the 20% discount spread plus accumulated APR. Withdraw or auto-enter the next cycle.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Eclipse.</span>
              <span className="block text-white/10">Redeem.</span>
            </h2>
          </div>
